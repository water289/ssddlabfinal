      ...
      steps {
        ...
        sh '''
          ...
          helm upgrade --install voting ./docker/helm/voting-system \
            ...
            --set postgres.containerSecurityContext.enabled=true \
            --set postgres.containerSecurityContext.runAsNonRoot=true \
            --set postgres.containerSecurityContext.runAsUser=1001 \
            --set postgres.containerSecurityContext.runAsGroup=1001 \
            --set postgres.containerSecurityContext.privileged=false \
            --set postgres.containerSecurityContext.allowPrivilegeEscalation=false \
            --set postgres.podSecurityContext.enabled=true \
            --set postgres.podSecurityContext.fsGroup=1001 \
            --set postgres.volumePermissions.enabled=true \
